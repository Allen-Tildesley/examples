...
PROGRAM md_chain_nve_lj
  ...
  USE md_module,        ONLY : introduction, conclusion, allocate_arrays, deallocate_arrays, zero_cm, force, worst_bond, &
       &                       r, r_old, v, f, n, potential_type, milcshake_a, milcshake_b, rattle_a, rattle_b
