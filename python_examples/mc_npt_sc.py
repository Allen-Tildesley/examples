...
def calculate ( string=None ):
    ...
    if string is None:
        ...
        v_r = VariableType ( nam = 'Volume ratio', val = 0.0 ) # The ratio is meaningless in this case
...
from maths_module     import random_translate_vector, random_rotate_vector, metropolis
