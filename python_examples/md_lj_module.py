...
def force_np ( box, r_cut, r ):
    """Takes in box, cutoff range, and coordinate array, and calculates forces and potentials etc.

    Uses NumPy routines to replace inner loop with vectorized statements.
    """
