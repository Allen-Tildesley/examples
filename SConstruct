...
variants['build_eos_lj']               = (['eos_lj.f90','eos_lj_module.f90','mc_lj_module.f90'],env_normal)
...
variants['build_mc_gibbs_lj']          = (['mc_gibbs_lj.f90','mc_gibbs_lj_module.f90','config_io_module.f90','averages_module.f90','maths_module.f90'],env_normal)
