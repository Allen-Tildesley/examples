...
variants={}
variants['build_bd_nvt_lj']        = (['bd_nvt_lj.f90','md_lj_module.f90','config_io_module.f90','averages_module.f90','utility_module.f90'],env_normal)
...
variants['build_initialize']       = (['initialize.f90','initialize_module.f90','config_io_module.f90','utility_module.f90'],env_normal)
variants['build_mc_npt_lj']        = (['mc_npt_lj.f90','mc_lj_module.f90','config_io_module.f90','averages_module.f90','utility_module.f90'],env_normal)
variants['build_mc_npt_lj_ll']     = (['mc_npt_lj.f90','mc_lj_ll_module.f90','link_list_module.f90','config_io_module.f90','averages_module.f90','utility_module.f90'],env_normal)
variants['build_mc_nvt_hs']        = (['mc_nvt_hs.f90','mc_hs_module.f90','config_io_module.f90','averages_module.f90'],env_normal)
variants['build_mc_nvt_lj']        = (['mc_nvt_lj.f90','mc_lj_module.f90','config_io_module.f90','averages_module.f90','utility_module.f90'],env_normal)
variants['build_mc_nvt_lj_ll']     = (['mc_nvt_lj.f90','mc_lj_ll_module.f90','link_list_module.f90','config_io_module.f90','averages_module.f90','utility_module.f90'],env_normal)
variants['build_mc_nvt_lj_re']     = (['mc_nvt_lj_re.f90','mc_lj_module.f90','config_io_module.f90','averages_module.f90','utility_module.f90'],env_mpi)
variants['build_mc_nvt_poly_lj']   = (['mc_nvt_poly_lj.f90','mc_poly_lj_module.f90','config_io_module.f90','averages_module.f90','utility_module.f90'],env_normal)
variants['build_mc_nvt_sc']        = (['mc_nvt_sc.f90','mc_sc_module.f90','config_io_module.f90','averages_module.f90','utility_module.f90'],env_normal)
variants['build_mc_zvt_lj']        = (['mc_zvt_lj.f90','mc_lj_module.f90','config_io_module.f90','averages_module.f90','utility_module.f90'],env_normal)
variants['build_mc_zvt_lj_ll']     = (['mc_zvt_lj.f90','mc_lj_ll_module.f90','link_list_module.f90','config_io_module.f90','averages_module.f90','utility_module.f90'],env_normal)
...
variants['build_md_chain_nve_lj']  = (['md_chain_nve_lj.f90','md_chain_lj_module.f90','config_io_module.f90','averages_module.f90','utility_module.f90'],env_lapack)
...
variants['build_qmc_pi_sho']       = (['qmc_pi_sho.f90','averages_module.f90','utility_module.f90'],env_normal)
variants['build_qmc_pi_lj']        = (['qmc_pi_lj.f90','qmc_pi_lj_module.f90','config_io_module.f90','averages_module.f90','utility_module.f90'],env_normal)
variants['build_qmc_walk_sho']     = (['qmc_walk_sho.f90','averages_module.f90','utility_module.f90'],env_normal)
